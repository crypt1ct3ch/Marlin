...
#define STRING_CONFIG_H_AUTHOR "(Crpt1cT3ch, Ender-3 Pro)" // Who made the changes.
...
// This can protect components from overheating, but NOT from short failures.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 89.39
  #define DEFAULT_bedKi 17.15
  #define DEFAULT_bedKd 310.53
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.7 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -53.1, -18.4, -2.86 }
